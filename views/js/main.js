...
var resizePizzas = function(size) {
        ...
        function changePizzaSizes(size) {
            ...
            var holder = document.querySelectorAll(".randomPizzaContainer");
            for (var i = holder.length; i--;) {

                    holder[i].style.width = newwidth;
                }
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var cols = 8;
            var s = 256;
            var pizzaCount = (window.screen.height / s) * cols;
            var holder = document.getElementById("movingPizzas1");
            for (var i = pizzaCount, elem; i--;) {
